...
////
typedef void (^RQReceivingHandler)(NSURLResponse *response, NSData *data);
typedef void (^RQResponseHandler)(NSURLResponse *response);
typedef void (^RQdidFailWithErrorHandler)(NSURLConnection *connection, NSMutableURLRequest *request, NSError *error);
//
typedef void (^RQProgressHandler)(float progress, NSInteger bytesTransferred, NSInteger totalBytes, NSURLResponse *response);
...
////
@property (nonatomic, copy) RQReceivingHandler receivingHandler;
@property (nonatomic, copy) RQResponseHandler responseHandler;
@property (nonatomic, copy) RQdidFailWithErrorHandler didFailWithErrorHandler;
//
